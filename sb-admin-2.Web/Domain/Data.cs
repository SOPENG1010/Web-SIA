...
namespace sb_admin_2.Web.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 11, nameOption = "Services", controller = "Home", action = "Forms", imageClass = "fa fa-edit fa-fw", status = true, isParent = true, parentId = 0 });
            menu.Add(new Navbar { Id = 12, nameOption = "Transcript of Record", controller = "Home", action = "TranscriptOfRecord", status = false, isParent = false, parentId = 11 });
